...
function ProjectInformationComponent() {
    ...
    const handleDownloadPdf = () => {
        ...
        doc.autoTable({
            head: [[{ content: 'Consultants', styles: { fillColor: headingFillColor, textColor: 0, fontStyle: 'bold' } }]],
            body: [],
            startY: yPos,
        });
        ...
        doc.autoTable({
            head: [[{ content: 'Requirements - Residence', styles: { fillColor: headingFillColor, textColor: 0, fontStyle: 'bold' } }]],
            body: [],
            startY: yPos,
        });
        yPos = (doc as any).autoTable.previous.finalY;
